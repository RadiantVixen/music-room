...
[![Django](https://img.shields.io/badge/Backend-Django%205.0%20%2F%20DRF-092E20?logo=django)](https://www.djangoproject.com/)
...
[![WebSockets](https://img.shields.io/badge/Real--Time-Django%20Channels%20%2F%20Redis-red?logo=redis)](https://redis.io/)
...
![Dynamic Track Voting and Real-time RowNumber Ranking](./assets/voting-flow.gif)
...
![Sentinel Position Playlist Sync and Version Consistency](./assets/collaborative-playlist.gif)
...
![Secure Device Delegation and Idempotent Playback Controls](./assets/device-delegation.gif)
...
1.  **Global Background Playback (`expo-av` & Zustand)**
...
2.  **Robust Offline Mode (`expo-file-system`)**
